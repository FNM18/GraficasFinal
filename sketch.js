...
const sketch = ({ context }) => {
  ...
  renderer.setClearColor("#331157", 1); // Color de fondo
  ...
  //Uso de mesh para asignarle un tipo de material a cada planeta
...
function createSpotlights(scene) {
  ...
  // Genera 6 spotlights para la escena
...
// Mandamos llamar a la funcion sketch
